...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        font.setFamily("Arial")
        font.setPointSize(10)
        self.radioButton_view_2.setFont(font)
        ...
        self.pushButton_leftup.setIcon(icon1)
        ...
        self.pushButton_rightup.setIcon(icon3)
        ...
        self.pushButton_leftdown.setIcon(icon6)
        ...
        self.pushButton_down.setIcon(icon7)
        ...
        self.pushButton_rightdown.setIcon(icon8)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.radioButton_view_2.setToolTip(QtWidgets.QApplication.translate("MainWindow", "Annotation Mode", None, -1))
        self.radioButton_view_2.setStatusTip(QtWidgets.QApplication.translate("MainWindow", "Annotation Mode", None, -1))
        ...
        self.pushButton_add.setStatusTip(QtWidgets.QApplication.translate("MainWindow", "add a group of annotations for this image.", None, -1))
        self.pushButton_add.setText(QtWidgets.QApplication.translate("MainWindow", "add", None, -1))
        self.pushButton_option.setStatusTip(QtWidgets.QApplication.translate("MainWindow", "options", None, -1))
        ...
        self.pushButton_load.setStatusTip(QtWidgets.QApplication.translate("MainWindow", "load a annotation file for this image.", None, -1))
        ...
        self.pushButton_leftup.setToolTip(QtWidgets.QApplication.translate("MainWindow", "left-top", None, -1))
        self.pushButton_leftup.setStatusTip(QtWidgets.QApplication.translate("MainWindow", "load the block on the left-top.", None, -1))
        self.pushButton_up.setToolTip(QtWidgets.QApplication.translate("MainWindow", "up", None, -1))
        self.pushButton_up.setStatusTip(QtWidgets.QApplication.translate("MainWindow", "load the block above.", None, -1))
        self.pushButton_up.setShortcut(QtWidgets.QApplication.translate("MainWindow", "Alt+Up", None, -1))
        self.pushButton_rightup.setToolTip(QtWidgets.QApplication.translate("MainWindow", "right-top", None, -1))
        self.pushButton_rightup.setStatusTip(QtWidgets.QApplication.translate("MainWindow", "load the block on the right-top.", None, -1))
        ...
        self.pushButton_leftdown.setToolTip(QtWidgets.QApplication.translate("MainWindow", "left-bottom", None, -1))
        self.pushButton_leftdown.setStatusTip(QtWidgets.QApplication.translate("MainWindow", "load the block on the left-bottom.", None, -1))
        self.pushButton_down.setToolTip(QtWidgets.QApplication.translate("MainWindow", "down", None, -1))
        self.pushButton_down.setStatusTip(QtWidgets.QApplication.translate("MainWindow", "to the block below.", None, -1))
        self.pushButton_down.setShortcut(QtWidgets.QApplication.translate("MainWindow", "Alt+Down", None, -1))
        self.pushButton_rightdown.setToolTip(QtWidgets.QApplication.translate("MainWindow", "right-bottom", None, -1))
        self.pushButton_rightdown.setStatusTip(QtWidgets.QApplication.translate("MainWindow", "load the block on the right-bottom.", None, -1))
